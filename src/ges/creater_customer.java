...
public class creater_customer extends javax.swing.JFrame {

    /**
     * Creates new form creater_customer
     */
    public creater_customer() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(creater_customer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new creater_customer().setVisible(true);
            }
        });
    }
